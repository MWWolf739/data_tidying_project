...
## Here we are cleaning up the column names, adding a column for business, filtering the data to look at retail and department store sales, gathering the data to long form 
df_retail <- df2 %>%
...
## now, your turn!
## Here we are ordering the data by year, determining the sum for each year for ## department stores, and reordering the data to match with df_retail
df_department <- df1 %>% 
...
df_total <- left_join(df_retail, df_department, by = "n")
```
